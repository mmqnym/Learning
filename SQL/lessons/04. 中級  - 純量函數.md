...
-- Ans:
-- "total_amount"	"day"
-- 5603.17	"Thu, 30/04/2020"
-- 2813.41	"Sat, 21/03/2020"
-- 2742.54	"Wed, 29/04/2020"
-- 2727.76	"Fri, 20/03/2020"
-- ...
```
</details>
...
/*
你可能會對像是 "5 days 34:58:38.571428" 的資料感到困惑
為何沒有自動進位成 "6 days 10:58:38.571428" 呢？

AVG() 函數在處理 interval 時，把它看作是由「月份」、「天數」和「秒數」等等這幾個獨立部分組成的結構。
它會分別計算這些部分的平均值，然後再把它們組合起來顯示。
可以使用 justify_interval() 函數來將 interval 自動進位。
*/
```
</details>